 ...
 * Copyright (c) 2009-2011 by _periodic_mobile, Inc. All Rights Reserved.
...
//@interface _periodic_mobileObject : NSObject
//@end

@interface _periodic_mobileObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[_periodic_mobileObject class]])
		{
			for (NSString *key in [[(_periodic_mobileObject*)o modules] allKeys])
			{
