...
@interface _periodic_mobileObject : KrollCoverageObject {
#else
@interface _periodic_mobileObject : KrollObject {
#endif
@private
...
extern NSString * _periodic_mobile$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	_periodic_mobileObject *__periodic_mobile;
	BOOL shutdown;
