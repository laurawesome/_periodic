...
// in simulator we redefine to format for _periodic_mobile Developer console
...
{\
	NSString * exceptionName = [@"org._periodic_mobile." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org._periodic_mobile";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UI_periodic_mobileNativeItemNone = -1, 
	UI_periodic_mobileNativeItemSpinner = -2,
	UI_periodic_mobileNativeItemProgressBar = -3,
	
	UI_periodic_mobileNativeItemSlider = -4,
	UI_periodic_mobileNativeItemSwitch = -5,
	UI_periodic_mobileNativeItemMultiButton = -6,
	UI_periodic_mobileNativeItemSegmented = -7,
	
	UI_periodic_mobileNativeItemTextView = -8,
	UI_periodic_mobileNativeItemTextField = -9,
	UI_periodic_mobileNativeItemSearchBar = -10,
	
	UI_periodic_mobileNativeItemPicker = -11,
	UI_periodic_mobileNativeItemDatePicker = -12,
	
	UI_periodic_mobileNativeItemInfoLight = -13,
	UI_periodic_mobileNativeItemInfoDark = -14,
	
	UI_periodic_mobileNativeItemDisclosure = -15,
	
	UI_periodic_mobileNativeItemContactAdd = -16
};
